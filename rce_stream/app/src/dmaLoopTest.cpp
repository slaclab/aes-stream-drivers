...
static struct PrgArgs DefArgs = { "/dev/axi_stream_dma_0", 0x3F, 0, 10000, 0,0x2,0x0,0 };
...
static struct argp_option options[] = {
   ...
   { "mask",    'm', "MASK",   OPTION_ARG_OPTIONAL, "Mask of dests for test. 1 bit per dest in hex. i.e. 0x3F.",0},
...
void *runRead ( void *t ) {
   ...
   printf("Starting read thread.  Lane=%i, Size=%i\n",rxData->dest,rxData->size);
