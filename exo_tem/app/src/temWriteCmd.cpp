/**
 *-----------------------------------------------------------------------------
 * Title      : TEM write command utility
 * ----------------------------------------------------------------------------
 * File       : temWriteCmd.cpp
 * Author     : Ryan Herbst, rherbst@slac.stanford.edu
 * Created    : 2016-08-08
 * Last update: 2016-08-08
 * ----------------------------------------------------------------------------
 * Description:
 * Program to send command. Data is prbs
 * ----------------------------------------------------------------------------
...
const  char * argp_program_version = "temWriteCmd 1.0";
...
int main (int argc, char **argv) {
   ...
   do {
      ...
      if ( ret <= 0 ) {
         ...
         // DMA Write
         ret = temWriteCmd(s,txData,args.size);
